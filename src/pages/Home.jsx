      ...
      <section class="bg-gradient-to-b from-lightPri from-85% to-lightSec dark:bg-gradient-to-b dark:from-darkPri from-85% dark:to-darkSec">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-normal lg:mb-8 md:text-lg lg:text-xl dark:text-white text-black">I am an innovative front-end developer who loves to build human-friendly interfaces.</p>
