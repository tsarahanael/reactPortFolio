...
const Home = () => {
  return (
    <>
      <section class="bg-white dark:bg-darkPri">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Sarah Tsangou</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">I am an innovative front-end developer who loves to build human-friendly interfaces.</p>
      ...
      <section className="bg-white dark:bg-darkSec lg:py-13 lg:px-42 px-8 py-6 text-center md:px-40 md:py-12 lg:py-14 xl:px-64 xl:py-16 2xl:px-72">
        <h2 className="mb-1 text-3xl dark:text-white font-semibold tracking-tight text-black md:mb-4 md:text-5xl lg:mb-6 lg:text-5xl xl:text-6xl 2xl:text-6xl">
          Recent projects
        </h2>
        <p
      ...
      <section
        class="bg-white dark:dark:bg-darkSec grid grid-cols-1 mx-auto md:grid-cols-3 gap-12 pt-2 p
      xl:px-32
      lg:px-24 
      md:px-14 
      px-12 
      ...
      >
        ...
        >
          ...
          <Button href="../public/portfolio/fashion/index.html">View project</Button>
        </Card>
        <Card
          className="max-w-sm mx-auto"
        ...
        >
          ...
          <Button href="../public/portfolio/project-hero/index-1.html">View project</Button>
        </Card>
        <Card
          className="max-w-sm mx-auto"
        ...
        >
          ...
          <Button href="../public/portfolio/smoothies/index.html">View project</Button>
        </Card>
      </section>
    </>
  );
